...
<?php
	...
	if (($_FILES['newphoto']['error'] == 0) &&
		...
		$mysqli5= new PDO("mysql:host=localhost; dbname=info230_SP12FP_Cupcake_Warriors", $dbusername, $dbpassword);
	    ...
	    $mysqli3= new PDO("mysql:host=localhost; dbname=info230_SP12FP_Cupcake_Warriors", $dbusername, $dbpassword);
...
?>
        ...
        <?php
$mysqli6= new PDO("mysql:host=localhost; dbname=info230_SP12FP_Cupcake_Warriors", $dbusername, $dbpassword);
